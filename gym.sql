...
-- Database: `gym`
--
CREATE DATABASE IF NOT EXISTS `gym` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `gym`;
...
CREATE TABLE `attendance` (
  ...
  `time_type` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `task_notification` (
  ...
  `task_to` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
  `title` varchar(250) COLLATE utf8_unicode_ci DEFAULT NULL,
